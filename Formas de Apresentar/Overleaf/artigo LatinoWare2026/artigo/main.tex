...
\title{ARIA: Pipeline Hierárquico \textit{Teacher-Student} para Detecção Automatizada de Anomalias em Rochas Ornamentais}
...
\IEEEauthorblockA{Instituto Federal do\\Espírito Santo (IFES)\\
Cachoeiro de Itapemirim, Brasil\\
rikemachado999@gmail.com}
\and
\IEEEauthorblockN{Rafael Silva Guimarães}
\IEEEauthorblockA{Instituto Federal do\\Espírito Santo (IFES)\\
Cachoeiro de Itapemirim, Brasil\\
rafaelg@ifes.edu.br}
\and
\IEEEauthorblockN{Everson Scherrer Borges}
\IEEEauthorblockA{Instituto Federal do\\Espírito Santo (IFES)\\
Cachoeiro de Itapemirim, Brasil\\
eversonborges@gmail.com}}
\else
