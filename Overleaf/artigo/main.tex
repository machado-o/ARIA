...
O controle de qualidade de chapas é uma etapa crítica da indústria de rochas ornamentais, setor estratégico para as exportações brasileiras e fortemente concentrado no Espírito Santo, principal polo produtor e exportador do país~\cite{stone_economy_bahiense2023}. A inspeção de anomalias superficiais --- como fissuras, veios, manchas e oxidações, entre outras --- é realizada de forma majoritariamente manual, dependendo da percepção visual do operador~\cite{stone_inspection_vidal2013}. Esse processo é inerentemente subjetivo, suscetível à fadiga e de difícil padronização, com impacto direto na precificação e nas perdas industriais~\cite{stone_subjectivity_castro2018}.
