...
\begin{abstract}
  ...
  \noindent\textbf{Keywords:} computer vision; ornamental stones; anomaly segmentation; foundation models; teacher-student learning.
\end{abstract}
...
\begin{resumo}
  ...
  \noindent\textbf{Palavras-chave:} visão computacional; rochas ornamentais; segmentação de anomalias; modelos de fundação; aprendizado \textit{Teacher-Student}.
\end{resumo}
